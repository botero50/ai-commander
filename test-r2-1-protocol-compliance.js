...
async function testEndpointConnectivity(logger) {
...
async function testResetEndpoint(logger) {
...
async function testStepEndpoint(logger) {
    const client = new RLHTTPClient(RL_HOST, RL_PORT, 10000, logger);
    try {
...
async function testEvaluateEndpoint(logger) {
    const client = new RLHTTPClient(RL_HOST, RL_PORT, 10000, logger);
    try {
