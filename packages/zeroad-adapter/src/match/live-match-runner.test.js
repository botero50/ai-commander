...
describe('Live Match Runner with Decision Overlay', () => {
    ...
    it('should capture decision metadata in overlay', () => {
        const overlay = new DecisionOverlay();
        overlay.recordDecision(42, 'player1', 'OllamaBrain', 'Complex reasoning about strategy', ['move_unit_to_position', 'queue_attack_command'], 256);
...
//# sourceMappingURL=live-match-runner.test.js.map