 ...
 */
export function createMatchHandler(viewerManager: MatchViewerManager) {
 ...
 */
export function getMatchHandler(viewerManager: MatchViewerManager, matchServer: MatchServer) {
  return (req: any, res: any) => {
    try {
 ...
 * GET /api/matches
 */
export function listMatchesHandler(viewerManager: MatchViewerManager, matchServer: MatchServer) {
  return (req: any, res: any) => {
    try {
 ...
 * GET /api/stats
 */
export function getStatsHandler(viewerManager: MatchViewerManager, matchServer: MatchServer) {
  return (req: any, res: any) => {
    try {
      const activeMatches = matchServer.getActiveMatches();
      ...
      res.json({
        ...
        viewers: {
          ...
          perMatch: Object.fromEntries(
            activeMatches.map((matchId) => [matchId, matchServer.getClientCount(matchId)])
          ),
        },
      });
    } catch (err) {
 ...
 */
export function closeMatchHandler(
  viewerManager: MatchViewerManager,
 ...
 */
export function setupMatchViewerRoutes(
  app: any,
  viewerManager: MatchViewerManager,
  matchServer: MatchServer
): void {
