...
describe('DecisionTimeline', () => {
    ...
    const createDecision = (tick, player, brain, reasoning, commands = []) => ({
        tick,
    ...
    it('should search decisions by reasoning keyword', () => {
        ...
        timeline.addDecision(createDecision(1, 'player1', 'Brain1', 'Defending fortress'), createSnapshot(1));
    ...
    it('should handle command parsing from string array', () => {
        const decision = createDecision(0, 'player1', 'Brain1', 'Training units', ['move-unit-to-10-20', 'train-infantry-barracks-5']);
...
//# sourceMappingURL=decision-timeline.test.js.map