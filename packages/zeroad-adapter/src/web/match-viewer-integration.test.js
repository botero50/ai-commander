...
import { createViewerIntegration, bindMatchResultToViewer, matchResultToViewerState, } from './match-viewer-integration.js';
...
describe('Match Viewer Integration', () => {
    ...
    it('should handle observations and update timeline', async () => {
        ...
        await integration.onObserve(mockObservationState);
        const state = viewer.getState();
...
//# sourceMappingURL=match-viewer-integration.test.js.map