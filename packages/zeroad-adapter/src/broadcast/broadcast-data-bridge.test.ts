...
describe('Broadcast Data Bridge (Story 57.1)', () => {
  ...
  describe('event subscription', () => {
    it('should allow data subscription', (done) => {
      let received = false;
  ...
  describe('observation transformation', () => {
    it('should transform observation events', (done) => {
      bridge.onBroadcastData((data) => {
    ...
    it('should include player stats in observation', (done) => {
      bridge.onBroadcastData((data) => {
        if (data.type === 'observation') {
    ...
    it('should cache last observation', (done) => {
      bridge.onBroadcastData((data) => {
        if (data.type === 'observation') {
  ...
  describe('decision transformation', () => {
    it('should transform decision events', (done) => {
      bridge.onBroadcastData((data) => {
    ...
    it('should include decision confidence', (done) => {
      bridge.onBroadcastData((data) => {
        if (data.type === 'decision') {
  ...
  describe('command transformation', () => {
    it('should transform command events', (done) => {
      bridge.onBroadcastData((data) => {
  ...
  describe('match lifecycle', () => {
    it('should emit match-start event', (done) => {
      bridge.onBroadcastData((data) => {
    ...
    it('should emit victory event on match end', (done) => {
  ...
  describe('broadcast data format', () => {
    it('should include timestamp in broadcast data', (done) => {
      bridge.onBroadcastData((data) => {
        if (data.type === 'observation') {
    ...
    it('should include matchId in broadcast data', (done) => {
  ...
  describe('realistic streaming scenario', () => {
    ...
    it('should provide broadcast-ready data for overlay consumption', (done) => {
