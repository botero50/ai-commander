...
test('ConfigurationLoader - missing gameExecutablePath throws error', () => {
    assert.throws(() => ConfigurationLoader.load({}), (err) => {
        const e = err;
        return (e instanceof ZeroADAdapterError &&
...
test('ConfigurationLoader - invalid ipcPort throws error', () => {
    assert.throws(() => ConfigurationLoader.load({
        gameExecutablePath: '/path/to/0ad',
        ipcPort: 99999,
    }), (err) => {
        const e = err;
...
//# sourceMappingURL=configuration-loader.test.js.map