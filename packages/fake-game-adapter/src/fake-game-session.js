...
export class FakeGameSession {
    ...
    async progressTick() {
        if (!this.active || this.paused) {
            throw new AdapterError('Cannot progress tick: session not active or paused', AdapterErrorCode.SessionNotActive);
        }
...
//# sourceMappingURL=fake-game-session.js.map