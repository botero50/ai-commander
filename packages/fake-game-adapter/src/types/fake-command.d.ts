...
export type FakeCommand = MoveCommand | WaitCommand | GatherCommand | DepositCommand | ProduceCommand | TrainCommand | ScoutCommand | MoveMilitaryCommand | AttackCommand;
/**
 ...
 */
export declare function parseFakeCommand(actionType: string, params?: Record<string, unknown>, agentId?: string): FakeCommand | null;
//# sourceMappingURL=fake-command.d.ts.map