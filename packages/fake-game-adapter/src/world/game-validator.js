...
export class GameValidator {
    ...
    async validateBrain(brain) {
        const results = [];
        const gameTypes = ['rts', 'turn-based-strategy', 'puzzle', 'card-game', 'simulation'];
     ...
     */
    async validateGameType(brain, gameType) {
     ...
     */
    createInputsForGameType(gameType, count) {
        const inputs = [];
