...
export class BenchmarkReportGenerator {
  private tournament: TournamentResult;
  private ratings?: Map<string, RatingSnapshot>;
...
`;
   ...
   */
  private extractStats(): CompetitorStats[] {
    ...
    for (const standing of this.tournament.standings) {
      statsMap.set(standing.competitor.id, {
        ...
        drawRate: standing.totalMatches > 0 ? standing.draws / standing.totalMatches : 0,
