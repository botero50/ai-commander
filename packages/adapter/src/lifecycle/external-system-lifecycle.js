 ...
 */
export var ExternalSystemHealthStatus;
(function (ExternalSystemHealthStatus) {
    ExternalSystemHealthStatus["Uninitialized"] = "uninitialized";
    ExternalSystemHealthStatus["Initializing"] = "initializing";
    ExternalSystemHealthStatus["Healthy"] = "healthy";
    ExternalSystemHealthStatus["Degraded"] = "degraded";
    ExternalSystemHealthStatus["Failed"] = "failed";
    ExternalSystemHealthStatus["Shutdown"] = "shutdown";
})(ExternalSystemHealthStatus || (ExternalSystemHealthStatus = {}));
/**
...
export class ExternalSystemLifecycle {
    logger;
    config;
    status = ExternalSystemHealthStatus.Uninitialized;
    initTime = null;
    shutdownTime = null;
    recentErrors = [];
    events = [];
    ...
    async performHealthCheck() {
        ...
        this.recentErrors = this.recentErrors.filter((e) => now - e.timestamp < this.config.errorWindowMs);
...
//# sourceMappingURL=external-system-lifecycle.js.map