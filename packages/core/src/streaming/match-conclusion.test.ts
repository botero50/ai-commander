...
describe('Match Conclusion (Story 57.3)', { timeout: 10000 }, () => {
  ...
  describe('conclusion sequence', () => {
    it('should emit victory-show event', () => {
    ...
    it('should emit stats-display event', () => {
      return new Promise<void>((resolve) => {
    ...
    it('should emit next-match-loading event', () => {
      return new Promise<void>((resolve) => {
    ...
    it('should emit conclusion-complete event', () => {
      return new Promise<void>((resolve) => {
        let complete = false;
  ...
  describe('statistics display', () => {
    it('should include all statistics fields', () => {
      return new Promise<void>((resolve) => {
        conclusion.onConclusion((event) => {
          if (event.type === 'stats-display' && event.data.statistics) {
    ...
    it('should generate highlight achievements', () => {
      return new Promise<void>((resolve) => {
        conclusion.onConclusion((event) => {
  ...
  describe('victory reason explanation', () => {
    ...
    it('should provide explanation for reason', () => {
      return new Promise<void>((resolve) => {
        conclusion.onConclusion((event) => {
  ...
  describe('timing', () => {
    it('should complete in approximately 6 seconds', () => {
      return new Promise<void>((resolve) => {
  ...
  describe('broadcast integration', () => {
    ...
    it('should trigger next match auto-start', () => {
      return new Promise<void>((resolve) => {
  ...
  describe('realistic broadcast scenario', () => {
    it('should complete full victory sequence', () => {
      return new Promise<void>((resolve) => {
    ...
    it('should provide smooth transition to next match', () => {
      return new Promise<void>((resolve) => {
