...
describe('ELO Rating System', () => {
    ...
    it('should preserve rating sum in matches', () => {
        const totalBefore = elo.getRating('brain1') + elo.getRating('brain2') + elo.getRating('brain3');
        elo.recordMatch('brain1', 'brain2', 1);
        elo.recordMatch('brain2', 'brain3', 0.5);
        const totalAfter = elo.getRating('brain1') + elo.getRating('brain2') + elo.getRating('brain3');
...
//# sourceMappingURL=elo-rating.test.js.map