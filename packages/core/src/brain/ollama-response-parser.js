...
exports.OllamaResponseParser = void 0;
class OllamaResponseParser {
    logger;
    playerID;
    constructor(logger, playerID) {
        this.logger = logger;
     ...
     */
    parseCommands(response, worldState) {
        const commands = [];
     ...
     */
    createGatherCommand(worldState) {
        const agents = worldState.agents || [];
     ...
     */
    createAttackCommand(worldState) {
        const agents = worldState.agents || [];
        ...
        const enemyUnits = agents
            ...
            .slice(0, 1);
        if (attackUnits.length === 0 || enemyUnits.length === 0)
            return null;
...
exports.OllamaResponseParser = OllamaResponseParser;
//# sourceMappingURL=ollama-response-parser.js.map