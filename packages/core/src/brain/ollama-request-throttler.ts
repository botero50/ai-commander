...
export interface ThrottlerConfig {
  delayBetweenRequests?: number; // ms between requests (default: 3000)
  maxQueueSize?: number; // max pending requests (default: 1, fire-and-forget)
}

export class OllamaRequestThrottler {
  ...
  constructor(logger: Logger, private playerId: string, config: ThrottlerConfig = {}) {
    this.logger = logger;
