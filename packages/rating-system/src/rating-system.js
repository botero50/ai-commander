...
export class RatingSystem {
    constructor() {
        ...
        this.history = [];
        this.kFactor = 32;
        this.confidenceLevel = 0.95; // 95% CI
    }
    initialize(players) {
    ...
    updateRecord(current, newElo, scoreGained) {
    ...
    wilsonConfidenceInterval(successes, trials, confidenceLevel) {
        if (trials === 0) {
