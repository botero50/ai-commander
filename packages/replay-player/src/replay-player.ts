...
export interface ReplayComparison {
  ...
  readonly keyMoments: ReadonlyArray<number>; // tick numbers
}
...
export class ReplayPlayer {
  static analyze(replay: MatchReplay): ReplayComparison {
    ...
    const keyMoments: Set<number> = new Set();
  ...
  static getTimeline(replay: MatchReplay): Array<{
    ...
    const divergenceSet = new Set<number>();
  ...
  private static arraysEqual(a: ReadonlyArray<string>, b: ReadonlyArray<string>): boolean {
